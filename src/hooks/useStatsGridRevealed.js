...
/**
 * When the stats grid enters (or already sits in) the viewport, set `true` once.
 * Uses native IntersectionObserver + takeRecords + a double-rAF geometry fallback
 * so iOS Safari still flips after Framer's useInView missed the first intersection.
 */
export function useStatsGridRevealed() {
